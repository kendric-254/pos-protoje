...
function GameShop() {
  ...
  return (
    <div className="dashboard bg-gray-200 rounded-3xl p-5 mt-56 lg:mt-24">
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {records.map((game, index) => (
            <div key={index} className="bg-white rounded-lg shadow-lg shadow-gray-600 p-6">
              <h2 className="text-4xl font-semibold mb-3">{game.game_name}</h2>
              <p className="text-2xl font-extrabold">Price: KES {game.price}</p>
              <img
                src={game.image}
                alt={game.game_name}
